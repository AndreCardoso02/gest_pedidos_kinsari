<div>
    ...
    <button wire:click="abrirModal" class="btn btn-primary">{{ __('Solicitar Alteracao do Pedido') }}</button>
                ...
                <div
                    ...
                    <div class="relative p-6 flex-auto">
                        <p class="my-4 text-blueGray-500 text-lg leading-relaxed">
                            Deseja realmente solicitar a alteracao do pedido?
                        </p>
                    </div>
                    <!--footer-->
                    <div class="flex items *:start justify-end p-6 border-t border-solid rounded-b border-blueGray-200">
                        ...
                        <button wire:click="solicitarAlteracaoPedido"
